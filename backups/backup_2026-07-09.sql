...
CREATE OR REPLACE FUNCTION "public"."get_store_display_user_ids"("p_company_id" "uuid") RETURNS TABLE("user_id" "uuid")
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select ur.user_id
...
ALTER FUNCTION "public"."get_store_display_user_ids"("p_company_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."shift_templates" (
    ...
    "branch_id" "uuid",
    "color" "text" DEFAULT '#4A90E2'::"text" NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL
);
...
COMMENT ON COLUMN "public"."shift_templates"."branch_id" IS 'NULL ise tum subeler icin gecerli (orn. OFF), doluysa sadece o subeye ozel';
...
CREATE POLICY "admin_deletes_branches" ON "public"."branches" FOR DELETE USING ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"]));



CREATE POLICY "admin_deletes_shift_templates" ON "public"."shift_templates" FOR DELETE USING ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"]));
...
CREATE POLICY "admin_updates_branches" ON "public"."branches" FOR UPDATE USING ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"])) WITH CHECK ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"]));
...
CREATE POLICY "admin_updates_shift_templates" ON "public"."shift_templates" FOR UPDATE USING ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"])) WITH CHECK ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"]));
...
CREATE POLICY "employee_manages_own_documents" ON "public"."employee_documents" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "only_admin_creates_branches" ON "public"."branches" FOR INSERT WITH CHECK ("public"."has_any_role"("company_id", ARRAY['company_admin'::"text"]));
...
GRANT ALL ON FUNCTION "public"."get_store_display_user_ids"("p_company_id" "uuid") TO "authenticated";
